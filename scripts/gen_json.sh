...
python taubin.py --source model --input ../models/teapot-fix.obj --output ../models/clean_teapot.json
...
python taubin.py --source model --input ../models/csg.ply --output ../models/clean_csg.json
